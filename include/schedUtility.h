/**
 * @file schedUtility.h
 * @brief Ordonnancement par un algorithme simple fondé sur des fnctions d'utilité 
 *
 */
 ...
 * passé en paramètre.
 */
struct schedACM_t * schedBatchUtil_create(struct DVBS2ll_t * dvbs2ll, int nbQoS, int declOK, int seqLgMax);
