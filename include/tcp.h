...
#define MSS 1460             /* maximum transmission unit = 1500 bytes => the webpage is splitted */
...
/**
 * @brief This function is used to create a session structure ( we will use this in a multiple session simulation )
 * @param client the one that initiates the connection
 * @param server the one that accepts the connection and send back the requested packets
 */
 ...
 * @param dg date generator for the transmission date of each PDU
 */
